...
r.write(
 ...
 %(D_2K, RPM, eta_KsStagnRated, L_KsStagn, N_K, p_vStagn) )
r.write(
...
r.write("16. Так как значение $$w_{1u}$$ может быть равно или близко к нулю,\
 ...
 %(turbine['geometry']['beta_1Blade'], beta_1) )
...
r.write("22. Выбираем шаг решетки соплового аппарата. В осевых турбинах 0.8…0.9. Принимаем\
 ...
 %(turbine['geometry']['coefficients']['t1Tol1'], turbine['geometry']['coefficients']['t1Tol1'], t_1))
...
r.write("38. Значения радиального зазора Δ между корпусом и колесом\
 ...
 %(turbine['geometry']['delta']*1e+03, G_losses) )
...
r.write("45. Выбираем шаг решетки рабочего колеса. В осевых турбинах 0.8…0.9. Принимаем\
 ...
 %(turbine['geometry']['coefficients']['t2Tol2'], turbine['geometry']['coefficients']['t2Tol2'], t_2))
...
r.write("58. Эта работа может быть определена также по формуле Эйлера:\
 ...
 %(L_Tu, abs(L_TuFromLosses - L_Tu)/L_TuFromLosses*100) )
...
r.write("61. Мощность, затрачиваемая на трение колеса в корпусе и вентиляцию\
 ...
 принятый как %0.1f):\
 \n$$\n N_{TB} = 0.735\\turbine['geometry']['coefficients']['beta'] {\\turbine['efficiency']['rho']_{1} + \\turbine['efficiency']['rho']_{2} \over 2}D_{1}^2\
