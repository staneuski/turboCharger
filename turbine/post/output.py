def output(Compressor,
    ...
    output_calc_error(Turbine.eta_error) # (61)
    ...
    output_calc_error(Turbine.N_error) # (62)

    print("If something doesn't work correctly make a new issue or\n"
          "check the others at https://github.com/StasF1/turboCharger/issues")
