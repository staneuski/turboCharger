def turbine(project, ambient, engine,
    ...
    pre(project, engine, compressor, turbine)

    (turbine, Turbine) = run(ambient, engine, compressor, Compressor, turbine)

    post(project, engine, compressor, Compressor, turbine, Turbine)
