...
eta_KsStagn = "DEFAULT" # 0…1 (0.6 - default) compressor energy conversion efficiency | КПД компрессора (весовой коэффициент) (для "TYPE2" - (15))
H_KsStagn   = "DEFAULT" # 0…1 (0.4 - default) | напорный изоэнтропный КПД (весовой коэффициент) (5)
phi_flow    = "DEFAULT" # 0…1 (0.4 - default) | коэффициент напора (весовой коэффициент) (6)
...
# "EQV" - предварительная оценка диаметра по формуле (для турбин с небольшим расходом)
# <00> - задание предварительной оценки диаметра явно (в см)
estimD_2    = "EQV" # BOOL / cm
