...
%(compressor['initial']['sigma_0'], compressor['initial']['T_aStagn'], compressor['initial']['p_aStagn']) )
...
По соображениям прочности рабочего колеса значение окружной скорости должно составлять\
 u2 ≤ 450…550 м/с.\n\n"
 %(D_2Init*1e+03, compressor['efficiency']['H_KsStagn'], u_2))
...
report.write("8. Для расчета потерь энергии во впускном патрубке из\
 ...
 %(compressor['losses']['dzeta_inlet'], L_inlet))
...
report.write("13. Наружный диаметр колеса на входе определяется из соотношения\
 ...
 %(D_2Init*1e+03, compressor['geometry']['coefficients']['relD_1B'], compressor['geometry']['coefficients']['relD_1H'], D_1H) )
report.write("14. Внутренний диаметр на входе (втулочный диаметр):\
 \n$$\n D_{1в} = \overline{D}D_{1н} = %0.5f \n$$\n\n" %D_1B)
if 'ON' in compressor['run']['roundDiamToSTD']:  report.write("15. Наружный диаметр колеса компрессора на выходе,\
...
Соответствующий план скоростей на входе в колесо показан на развертке\
 ...
 %(compressor['geometry']['iDeg'], beta_1Blade) )
report.write(
...
report.write("26. Потери (удельная работа потерь) во входном вращающемся направляющем\
 ...
 %(compressor['losses']['dzeta_BA'], L_BA) )
report.write("27. Радиальная составляющая $$c_{2r}$$ абсолютной скорости,\
 ...
 %(compressor['geometry']['coefficients']['relW_2rToC_1a'], c_2r) )
report.write("28. Потери $$\Delta L_{пт}$$ на поворот и трение в межлопаточных каналах\
 ...
 %(compressor['losses']['dzeta_TF'], L_TF) )
report.write("29. Потери на трение диска колеса о воздух в сумме с вентиляционными\
 ...
 выберем _α_ = %1.3f.\n\n"
 %(L_TB, compressor['losses']['alpha_wh']) )
...
if 'VANELESS' in compressor['run']['diffuserType']: # Vaneless diffuser | БЛД
    ...
    %(compressor['geometry']['coefficients']['vanelessWideCoef'], compressor['geometry']['coefficients']['vanelessWideCoef'], b_4) )
    ...
    %(compressor['geometry']['coefficients']['vanelessDiamCoef'], compressor['geometry']['coefficients']['vanelessDiamCoef'], D_4) )
    report.write(
    ...
    %(compressor['efficiency']['eta_diff'], n_4) )
    ...
    %(compressor['geometry']['coefficients']['relDiffOutToCompOut'], compressor['geometry']['coefficients']['relDiffOutToCompOut'], c_K) )
    ...
    %(compressor['geometry']['coefficients']['vanelessWideCoef'], compressor['geometry']['coefficients']['vanelessWideCoef'], b_3) )
    ...
    %(compressor['geometry']['coefficients']['vanelessDiamCoef'], compressor['geometry']['coefficients']['vanelessDiamCoef'], D_3) )
    ...
    %(compressor['efficiency']['eta_diff'], n_3) )
    report.write("47. Температура на выходе из диффузора определяется методом последовательных\
    приближений из уравнения:\
    \n$$\n {1 \over \\beta^{m}} + {\\beta - 1 \over \sigma q} -\
    ...
    %(compressor['geometry']['coefficients']['vanedWideCoef'], compressor['geometry']['coefficients']['vanedWideCoef'], b_4) )
    report.write("52. Наружный диаметр лопаточной части диффузора выбирают в пределах $$(1.35…1.7)D_{2}$$.\
    Принимаем значение коэффициента %0.2f. В результате:\
    \n$$\n D_{4} = %0.2f D_{2} = %1.4f\quad м\n$$\n\n"
    %(compressor['geometry']['coefficients']['vanedDiamCoef'], compressor['geometry']['coefficients']['vanedDiamCoef'], D_4) )
    report.write(
    "![alt text](compressor/axisCut.png)\n\
    <center>\
    ...
    %(compressor['geometry']['deltaDiffuser'], alpha_4) )
    ...
    %(compressor['load']['tau_3'], compressor['load']['tau_4'], T_3))
...
report.write("%0.0f. Показатель $$n_{ул}$$ политропы сжатия в воздухосборнике (улитке) составляет обычно\
 ...
 %(i + 1, compressor['losses']['n_housing']))
