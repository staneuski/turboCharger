def set_standard(size):
    ...
    '''
    if size < 1:
        print("\033[93mWarning! Size is too small to be standartized!\
    ...
    elif (size >= 42.5) & (size < 47.5):
        size = 45
    elif (size >= 47.5) & (size < 49):
        size = 48
    elif (size >= 49) & (size < 51):
        size = 50
    elif (size >= 51) & (size < 53.5):
        size = 52
    elif (size >= 53.5) & (size < 57.5):
        size = 55
    elif (size >= 57.5) & (size < 59):
        size = 58
    elif (size >= 59) & (size < 62.5):
        size = 60
    elif (size >= 60) & (size < 250):
