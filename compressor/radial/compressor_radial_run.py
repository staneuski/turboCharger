def compressor_radial_run(run, engine, compressor):
    ...
    from plot2func import z_plot2func, H_plot2func, phi_plot2func, relSpeeds_plot2func,\
                                   relD_1H_plot2func, relD_1B_plot2func
    ...
    class CompCalc:
        ...
        compressor['efficiency']['H_KsStagn'] = H_plot2func(
            compressor['efficiency']['H_KsStagn'], compressor['geometry']['D_2']
        )
        ...
        compressor['efficiency']['phi_flow'] = phi_plot2func(
            compressor['efficiency']['phi_flow'], compressor['geometry']['D_2'])
        ...
        compressor['geometry']['coefficients']['relD_1H'] = relD_1H_plot2func(
            compressor['geometry']['coefficients']['relD_1H'], compressor['geometry']['D_2']
        )
        compressor['geometry']['coefficients']['relD_1B'] = relD_1B_plot2func(
            compressor['geometry']['coefficients']['relD_1B'], compressor['geometry']['D_2']
        )
        relD_1BToH = (
        ...
        if 'ON' in compressor['geometry']['coefficients']['DToSTD']:
            compressor['geometry']['D_2'] = set_standard( D_2estimated )*1e-03 # [m]
        else:
            if D_2estimated <= 85:
                compressor['geometry']['D_2'] = round( D_2estimated*2, -1 )/2*1e-03 # [m]
            else:
                compressor['geometry']['D_2'] = round( D_2estimated, -1 )*1e-03 # [m]
        ...
        n_tCh = 60*u_2/math.pi/compressor['geometry']['D_2'] # [1/min]
        ...
        #   на выходе из колеса
        compressor['geometry']['coefficients']['relW_2rToC_1a'] = relSpeeds_plot2func(
            compressor['geometry']['coefficients']['relW_2rToC_1a'], compressor['geometry']['D_2']
        )
        ...
        zLower = z_plot2func(0, compressor['geometry']['D_2']);    zUpper = z_plot2func(1, compressor['geometry']['D_2'])
        ...
        | (compressor['geometry']['z_K'] > zUpper)):
            exit('\033[91mError 30: Number of blades is not in the allowable diapason!\n\
                ...
                %(compressor['geometry']['D_2']*1e+03, round(zLower + 0.5), int(zUpper)))
        ...
        b_2 = compressor['G_K']/math.pi/compressor['geometry']['D_2']/c_2r/rho_2/compressor['load']['tau_2']
        ...
        if 'VANELESS' in compressor['diffuser']:
            ...
            D_4 = compressor['geometry']['coefficients']['vanelessDiamCoef']*compressor['geometry']['D_2']
            ...
            while (
                abs(
                    diffuser_outlet_T(engine['inlet'],b_2,compressor['geometry']['D_2'],T_2,c_2,b_4,D_4,T_4,n_4)
                    - T_4
                ) > validity
            ):
                T_4 += validity
            ...
            D_3 = compressor['geometry']['coefficients']['vanelessDiamCoef']*compressor['geometry']['D_2']
            ...
            while (
                abs(
                    diffuser_outlet_T(engine['inlet'],b_2,compressor['geometry']['D_2'],T_2,c_2,b_3,D_3,T_3,n_3)
                    - T_3
                ) > validity
            ):
                T_3 += validity
                ...
                T_3 = diffuser_outlet_T(engine['inlet'],b_2,compressor['geometry']['D_2'],T_2,c_2,b_3,D_3,T_3, n_3)
            ...
            D_4 = compressor['geometry']['coefficients']['vanedDiamCoef']*compressor['geometry']['D_2']
